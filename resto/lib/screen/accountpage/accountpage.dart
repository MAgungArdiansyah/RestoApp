...
import 'package:resto/screen/accountpage/widget/appbar.dart';
import 'package:resto/screen/accountpage/widget/customDialog.dart';
import 'package:resto/screen/accountpage/widget/photoprofile.dart';
import 'package:resto/screen/accountpage/widget/userstats.dart';
...
class _AccountPageState extends State<AccountPage> {
  ...
  Widget build(BuildContext context) {
    ...
    print(_databaseServices.id.toString());
    //DatabaseServices(id: _userModel.uid);
